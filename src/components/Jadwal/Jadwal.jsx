...
export const Jadwal = ({ property1, className, calendar = "/img/calendar-1.svg", divClassName }) => {
  ...
  return (
    ...
    >
      ...
      >
        <a href="/jadwalsampahadmin" className="font-body-1-regular w-fit tracking-[var(--body-1-regular-letter-spacing)] [font-style:var(--body-1-regular-font-style)] text-[length:var(--body-1-regular-font-size)] text-primary-2 font-[number:var(--body-1-regular-font-weight)] text-center whitespace-nowrap leading-[var(--body-1-regular-line-height)] relative">Edit Profile</a>
      </div>
    </div>
  );
};
