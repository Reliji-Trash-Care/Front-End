...
export const BeritaUser = () => {
  return (
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-primary-1 overflow-hidden w-[1440px] h-[2329px] relative">
        <ContainerBerita
          buttonText="Baca Selengkapnya"
          className="!absolute !left-[324px] !w-[996px] !top-[86px]"
        ...
        />
        <div className="absolute w-[996px] h-[1735px] top-[508px] left-[324px]">
          <div className="absolute w-[996px] h-[1672px] top-[63px] left-0">
            <div className="flex w-[997px] h-[62px] items-center justify-between pt-[20px] pb-0 px-0 absolute top-[1610px] left-0 border-t-[0.5px] [border-top-style:solid] border-variable-collection-pure-black">
            ...
            <div className="absolute w-[996px] h-[1521px] top-0 left-0">
              <div className="absolute w-[486px] h-[491px] top-0 left-0 bg-primary-1 rounded-[15px] shadow-drop-shadow-2">
              ...
              <div className="absolute w-[486px] h-[491px] top-0 left-[510px] bg-primary-1 rounded-[15px] shadow-drop-shadow-2">
                <div className="flex flex-col w-[451px] items-start gap-[32px] absolute top-[16px] left-[18px]">
                  <div className="flex flex-col items-start gap-[24px] relative self-stretch w-full flex-[0_0_auto]">
                    <img
              ...
              <div className="absolute w-[486px] h-[491px] top-[515px] left-0 bg-primary-1 rounded-[15px] shadow-drop-shadow-2">
                <div className="flex flex-col w-[451px] items-start gap-[32px] absolute top-[16px] left-[18px]">
                  <div className="flex flex-col items-start gap-[24px] relative self-stretch w-full flex-[0_0_auto]">
                    <img
              ...
              <div className="absolute w-[486px] h-[491px] top-[515px] left-[510px] bg-primary-1 rounded-[15px] shadow-drop-shadow-2">
                <div className="flex flex-col w-[451px] items-start gap-[32px] absolute top-[16px] left-[18px]">
                  <div className="flex flex-col items-start gap-[24px] relative self-stretch w-full flex-[0_0_auto]">
                    <img
                      className="relative self-stretch w-full h-[239px] object-cover"
                    ...
                    <div className="flex-col h-[100px] gap-px flex items-start relative self-stretch w-full">
                      ...
                      <p className="relative self-stretch mb-[-35.00px] font-body-2-regular font-[number:var(--body-2-regular-font-weight)] text-tersier-2 text-[length:var(--body-2-regular-font-size)] tracking-[var(--body-2-regular-letter-spacing)] leading-[var(--body-2-regular-line-height)] [font-style:var(--body-2-regular-font-style)]">
                        Dua orang oknum warga Kota Jambi tertangkap tangan membuang sampah tidak&nbsp;&nbsp;pada
                        waktunya.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="flex w-[451px] items-start gap-[8px] absolute top-[443px] left-[9px]">
                  <div className="inline-flex items-start relative flex-[0_0_auto] mix-blend-multiply">
                    <div className="inline-flex items-center justify-center px-[10px] py-[2px] relative flex-[0_0_auto] bg-primary-1 rounded-[16px]">
                      <div className="relative w-fit mt-[-1.00px] font-body-2-semibold font-[number:var(--body-2-semibold-font-weight)] text-tersier-2 text-[length:var(--body-2-semibold-font-size)] text-center tracking-[var(--body-2-semibold-letter-spacing)] leading-[var(--body-2-semibold-line-height)] whitespace-nowrap [font-style:var(--body-2-semibold-font-style)]">
                        Sampah Liar
              ...
              <div className="absolute w-[486px] h-[491px] top-[1030px] left-0 bg-primary-1 rounded-[15px] shadow-drop-shadow-2">
                <div className="flex flex-col w-[451px] items-start gap-[32px] absolute top-[16px] left-[18px]">
                  <div className="flex flex-col items-start gap-[24px] relative self-stretch w-full flex-[0_0_auto]">
                    <img
              ...
              <div className="absolute w-[486px] h-[491px] top-[1030px] left-[510px] bg-primary-1 rounded-[15px] shadow-drop-shadow-2">
                <div className="flex flex-col w-[451px] items-start gap-[32px] absolute top-[16px] left-[18px]">
                  <div className="flex flex-col items-start gap-[24px] relative self-stretch w-full flex-[0_0_auto]">
                    <img
                    ...
                    <div className="flex-col h-[100px] gap-px flex items-start relative self-stretch w-full">
                      ...
                      <p className="relative self-stretch mb-[-35.00px] font-body-2-regular font-[number:var(--body-2-regular-font-weight)] text-tersier-2 text-[length:var(--body-2-regular-font-size)] tracking-[var(--body-2-regular-letter-spacing)] leading-[var(--body-2-regular-line-height)] [font-style:var(--body-2-regular-font-style)]">
                        Kota Jambi menghadapi masalah serius akibat meningkatnya jumlah sampah yang belum teratasi
                        dengan baik.
                      </p>
                    </div>
                  </div>
