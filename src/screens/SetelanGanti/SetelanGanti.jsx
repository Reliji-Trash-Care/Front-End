        ...
        <div className="absolute w-[1674px] h-[1787px] top-[86px] left-[242px]">
          ...
          <div className="inline-flex flex-col items-start gap-[36px] absolute top-[38px] left-[109px]">
            <Jadwal
              ...
              divClassName="!mt-[-1.00px] !text-primary-2 !tracking-[0] !text-[16px] ![font-style:unset] !font-normal ![font-family:'Nunito',Helvetica] !leading-[22.4px]"
              hasCalendar={false}
              property1="default"
              text="Edit Profil"
            />
            <Jadwal
              className="!flex-[0_0_auto] !bg-secondary-1"
              divClassName="!mt-[-1.00px] !text-primary-2 !tracking-[0] !text-[16px] ![font-style:unset] !font-bold ![font-family:'Nunito',Helvetica] !leading-[22.4px]"
              hasCalendar={false}
              property1="default"
              text="Ganti Password"
            />
            <Jadwal
              className="!flex-[0_0_auto]"
              divClassName="!mt-[-1.00px] !text-primary-2"
              hasCalendar={false}
              property1="default"
              text="Notifikasi"
            />
