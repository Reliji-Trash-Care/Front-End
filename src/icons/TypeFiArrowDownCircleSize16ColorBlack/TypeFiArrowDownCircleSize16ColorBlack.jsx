...
export const TypeFiArrowDownCircleSize16ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_143_11561)">
        <path
        ...
        />
        <path
          d="M5.33334 8L8.00001 10.6667L10.6667 8"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="2"
...
TypeFiArrowDownCircleSize16ColorBlack.propTypes = {
