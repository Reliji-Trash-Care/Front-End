...
export const TypeFiDownloadCloudSize24ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_143_5048)">
        <path d="M8 17L12 21L16 17" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        <path d="M12 12V21" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        <path
...
TypeFiDownloadCloudSize24ColorBlack.propTypes = {
