...
export const TypeFiUserMinusSize64ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path
        ...
        strokeWidth="2"
      />
      <path d="M30.6667 14.6667H22.6667" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
      <path
...
TypeFiUserMinusSize64ColorBlack.propTypes = {
