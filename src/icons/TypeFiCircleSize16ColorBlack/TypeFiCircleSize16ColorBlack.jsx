...
export const TypeFiCircleSize16ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_143_11456)">
        <path
...
TypeFiCircleSize16ColorBlack.propTypes = {
