...
export const TypeFiPhoneIncomingSize16ColorWhite = ({ color = "white", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_143_9990)">
        <path
          d="M10.6667 1.33334V5.33334H14.6667"
          stroke={color}
          strokeLinecap="round"
        ...
        />
        <path
          d="M15.3333 0.666656L10.6667 5.33332"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="2"
...
TypeFiPhoneIncomingSize16ColorWhite.propTypes = {
