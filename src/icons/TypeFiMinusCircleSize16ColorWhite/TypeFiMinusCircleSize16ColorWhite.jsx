...
export const TypeFiMinusCircleSize16ColorWhite = ({ color = "white", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_143_10062)">
        <path
...
TypeFiMinusCircleSize16ColorWhite.propTypes = {
