...
export const TypeFiFrownSize16ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_143_11296)">
        <path
        ...
        />
        <path
          d="M10.6667 10.6667C10.6667 10.6667 9.66668 9.33334 8.00001 9.33334C6.33334 9.33334 5.33334 10.6667 5.33334 10.6667"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="2"
...
TypeFiFrownSize16ColorBlack.propTypes = {
