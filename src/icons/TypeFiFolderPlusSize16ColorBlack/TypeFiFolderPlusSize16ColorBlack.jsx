...
export const TypeFiFolderPlusSize16ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path
        ...
        strokeWidth="2"
      />
      <path d="M16 14.6667V22.6667" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
      <path d="M12 18.6667H20" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
    </svg>
  );
};

TypeFiFolderPlusSize16ColorBlack.propTypes = {
