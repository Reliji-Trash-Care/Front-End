...
export const TypeFiInboxSize64ColorWhite = ({ color = "white", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path d="M22 12H16L14 15H10L8 12H2" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
      <path
...
TypeFiInboxSize64ColorWhite.propTypes = {
