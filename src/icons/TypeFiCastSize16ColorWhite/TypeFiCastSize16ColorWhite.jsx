...
export const TypeFiCastSize16ColorWhite = ({ color = "white", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path d="M2 20H2.01" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
      <path
...
TypeFiCastSize16ColorWhite.propTypes = {
