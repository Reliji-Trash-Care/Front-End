...
export const TypeFiSmileSize16ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_143_10878)">
        <path
        ...
        />
        <path
          d="M5.33334 9.33334C5.33334 9.33334 6.33334 10.6667 8.00001 10.6667C9.66668 10.6667 10.6667 9.33334 10.6667 9.33334"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="2"
...
TypeFiSmileSize16ColorBlack.propTypes = {
