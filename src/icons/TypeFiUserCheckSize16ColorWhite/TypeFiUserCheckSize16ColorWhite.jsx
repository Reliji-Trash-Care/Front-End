...
export const TypeFiUserCheckSize16ColorWhite = ({ color = "white", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
...
TypeFiUserCheckSize16ColorWhite.propTypes = {
