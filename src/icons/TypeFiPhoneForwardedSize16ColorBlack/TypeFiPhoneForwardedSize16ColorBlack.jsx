...
export const TypeFiPhoneForwardedSize16ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_143_11044)">
        <path
          d="M12.6667 0.666656L15.3333 3.33332L12.6667 5.99999"
          stroke={color}
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="2"
        />
        <path d="M10 3.33334H15.3333" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        <path
...
TypeFiPhoneForwardedSize16ColorBlack.propTypes = {
