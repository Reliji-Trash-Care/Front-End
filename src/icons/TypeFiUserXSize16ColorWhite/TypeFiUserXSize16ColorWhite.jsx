...
export const TypeFiUserXSize16ColorWhite = ({ color = "white", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
...
TypeFiUserXSize16ColorWhite.propTypes = {
