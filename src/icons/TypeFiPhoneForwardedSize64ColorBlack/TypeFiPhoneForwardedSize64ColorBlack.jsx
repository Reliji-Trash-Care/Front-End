...
export const TypeFiPhoneForwardedSize64ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path
        d="M50.6667 2.66675L61.3334 13.3334L50.6667 24.0001"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="2"
      />
      <path d="M40 13.3333H61.3333" stroke={color} strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
      <path
...
TypeFiPhoneForwardedSize64ColorBlack.propTypes = {
