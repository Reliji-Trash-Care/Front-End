...
export const TypeFiXCircleSize16ColorWhite = ({ color = "white", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
...
TypeFiXCircleSize16ColorWhite.propTypes = {
