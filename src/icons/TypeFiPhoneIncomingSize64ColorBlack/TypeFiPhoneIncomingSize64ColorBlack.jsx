...
export const TypeFiPhoneIncomingSize64ColorBlack = ({ color = "black", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <path
        d="M42.6667 5.33325V21.3333H58.6667"
        stroke={color}
        strokeLinecap="round"
      ...
      />
      <path
        d="M61.3334 2.66675L42.6667 21.3334"
        stroke={color}
        strokeLinecap="round"
        strokeLinejoin="round"
        strokeWidth="2"
...
TypeFiPhoneIncomingSize64ColorBlack.propTypes = {
