...
export const TypeFiPhoneSize16ColorWhite = ({ color = "white", className }) => {
  return (
    <svg
      className={`${className}`}
      fill="none"
    ...
    >
      <g clipPath="url(#clip0_143_10000)">
        <path
...
TypeFiPhoneSize16ColorWhite.propTypes = {
